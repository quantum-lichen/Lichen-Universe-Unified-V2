...
[![Status](https://img.shields.io/badge/status-development-blue)](CHANGELOG.md)
...
### 🌟 Genesis
* [Vision & Introduction](README.md)
* [System Manifest V3.0](manifest.json)
* [Unified Architecture V5 (Blueprint)](architecture/UNIFIED_ARCHITECTURE_V5.md)

### 🗣️ The Language Trinity
* [Overview: The Complete Ecosystem](Languages/README.md)
* [ΦLang: Mathematical AI Protocol](Languages/PHILANG/WHITEPAPER.md)
    * [Formulas & Constants](Languages/PHILANG/FORMULAS.md)
    * [Compiler Specification](Languages/PHILANG/src/compiler/compiler.py)
* [HELIX-Φ: Biological DNA Encoding](Languages/HELIX-PHI/README.md)
* [LGL: Iconic Visual Interface](Languages/LGL-Lichen-Glyph_Language/LGL_SPEC_V1.0.md)

### ⚡ Layer 1: The Silicon Substrate (Hardware)
* [Snowflake-Ω CPU Blueprint](OMEGA_SEED_BLUEPRINT.md)
* [TensorOS: Bare-Metal Kernel](architecture/neuroLang_TensorOS/README.md)
* [Microfluidic Φ-Cooling](hardware/cooling/cool_flow_specs.md)

### 🧬 Layer 2: Organic Logic & Data
* [ACΦ-496: The Organic Engine](architecture/ACPHI/acphi-496.md)
* [UHFS: Holographic File System](architecture/UHFS/uhfs.md)
* [FC-496: The Atomic Unit](FC-496/README.md)
* [ZPA: Zero-Parse Architecture](architecture/Zero-Parse-Architecture_ZPA/whitepapper.md)

### 🌐 Layer 3: Network & Protocols
* [HNP: Harmonic Network Protocol](harmonic-network-protocol/README.md)
* [Tzolk'in Cryptography (OTP)](https://quantum-lichen.github.io/universal-language-tzolkin/)
* [TzBit: Hybrid Quantum Computing](architecture/quantum/TzBit.md)

### 🧠 Layer 4: Cognition & Safety
* [CEML: Cognitive Entropy Law](theories/CEML/README.md)
* [EHE: Ethical Homeostasis Engine](éthique/README.md)
* [LES: Low-Entropy Spiral Attractor](LES/docs/whitepaper_les_v1.md)
* [Geometric Cognition Hypothesis](Geometric_cognition/Geometric_Cognition_Hypothesis.md)

### 💾 Layer 5: Time & Preservation
* [CRAID: Distributed Cognitive RAID](architecture/CRAID/craid.md)
* [U.R.S.A: The 1000-Year Archive](architecture/URSA/Whitepaper.md)
* [π-Time: Fractal Chronology](Pi-Time/README.md)
...
<br>
[![Lichen Hybrid Kernel Live](https://img.shields.io/badge/Lichen_Hybrid_Kernel-Live-00ff00?style=for-the-badge&logo=streamlit)](https://universal-language-tzolkin-2aafrwp7k8ubh7qmxeqtkc.streamlit.app/)
<br>
[![Lichen Quantum Crystal Live](https://img.shields.io/badge/Lichen_Quantum_Crystal-Live-00ff00?style=for-the-badge&logo=streamlit)](https://lichen-universe-unified-v2-m98dnd996ujujewhwharot.streamlit.app/)
<br>
[![ΦLang Runtime Live](https://img.shields.io/badge/ΦLang_Runtime_Environment-Live-00ff00?style=for-the-badge&logo=streamlit)](https://nordique-analyzer-v20-8rxkgse35hgyqjazmyv4y9.streamlit.app/)
<br>
[![Mandala 496 Live](https://img.shields.io/badge/Mandala_496_(E8xE8)-Live-00ff00?style=for-the-badge&logo=streamlit)](https://lichen-universe-unified-v2-5epv8mnnohcup8ew5lzgns.streamlit.app/)
